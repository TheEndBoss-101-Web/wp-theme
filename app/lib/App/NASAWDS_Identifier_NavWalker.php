 ...
 */
class NASAWDS_Identifier_NavWalker extends \Walker_Nav_Menu {
    ...
    function start_el(&$output, $item, $depth = 0, $args = null, $id = 0) {
        ...
        $classes[] = 'usa-identifier__required-links-item';
        $classes[] = 'desktop:grid-col-auto';
        $classes[] = 'usa-footer__primary-content';
